[![Run App ColinSafford](https://github.com/csafford02/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/csafford02/GithubActions/actions/workflows/run-app.yaml)
